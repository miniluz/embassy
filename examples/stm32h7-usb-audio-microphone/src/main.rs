...
async fn main(spawner: Spawner) {
    ...
    spawner.spawn(unwrap!(usb_control_task(control_monitor, volume_state)));
    spawner.spawn(unwrap!(usb_streaming_task(stream, receiver)));
    spawner.spawn(unwrap!(usb_task(usb_device)));
    spawner.spawn(unwrap!(audio_generator_task(sender, volume_state)));
